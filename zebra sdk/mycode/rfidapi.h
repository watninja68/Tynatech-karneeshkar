...
RFID_STATUS WINAPI RFID_SetZoneReaderConfig(
		RFID_HANDLE32 readerHandle,
		LPZONE_TRANSITION_READER_CONFIG zoneReaderConfig,
		LPVOID rsvd);
		
RFID_STATUS WINAPI RFID_PerformPortalInventory(
		RFID_HANDLE32 readerHandle,
		LPZONE_TRANSITION_REPORT_CONFIG lpZoneTransitionReportConfig,
		LPTRIGGER_INFO lpTriggerInfo,
		LPVOID rsvd);

RFID_STATUS WINAPI RFID_StopPortalInventory(
		RFID_HANDLE32 readerHandle);
