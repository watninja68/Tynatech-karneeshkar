...
typedef enum _TAG_FIELD
{
	...
	TAG_COORDINATES				= 32768, /**<   Fetch the tag cooridnates */
...
/**
 *    Specifies Tag transition status
  */
typedef enum _TAG_TRANSITION_STATUS
{
	 TAG_ENTRY = 0, /**< Specifies Tag enters the particular zone */
	 TAG_EXIT, /**< Specifies Tag exit the particular zone */
	 TAG_TRANSITIONED ,/**< Specifies tag transitioned from one zone to another zone */
	 TAG_TRANSITION_NONE //** Specifies Tag has not transitioned at all */
}TAG_TRANSITION_STATUS;

typedef enum _ZONE_ANTENNA_POLARIZATION
{
	ZONE_ANTENNA_LHCP = 0,  		//**< LHCP is used for polarization*/
	ZONE_ANTENNA_THETA,				//**< THETA is used for polarization*/
	ZONE_ANTENNA_PHI				//**< PHI used for polarization*/
}ZONE_ANTENNA_POLARIZATION;
